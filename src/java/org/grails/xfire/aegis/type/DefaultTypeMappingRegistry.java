...
import org.grails.xfire.aegis.type.basic.Base64Type;
import org.grails.xfire.aegis.type.basic.BigDecimalType;
import org.grails.xfire.aegis.type.basic.BigIntegerType;
import org.grails.xfire.aegis.type.basic.BooleanType;
import org.grails.xfire.aegis.type.basic.CalendarType;
import org.grails.xfire.aegis.type.basic.CharacterType;
import org.grails.xfire.aegis.type.basic.DateTimeType;
import org.grails.xfire.aegis.type.basic.DoubleType;
import org.grails.xfire.aegis.type.basic.FloatType;
import org.grails.xfire.aegis.type.basic.IntType;
import org.grails.xfire.aegis.type.basic.LongType;
import org.grails.xfire.aegis.type.basic.ObjectType;
import org.grails.xfire.aegis.type.basic.ShortType;
import org.grails.xfire.aegis.type.basic.SqlDateType;
import org.grails.xfire.aegis.type.basic.StringType;
import org.grails.xfire.aegis.type.basic.TimeType;
import org.grails.xfire.aegis.type.basic.TimestampType;
import org.grails.xfire.aegis.type.basic.URIType;
import org.grails.xfire.aegis.type.mtom.DataHandlerType;
import org.grails.xfire.aegis.type.mtom.DataSourceType;
import org.grails.xfire.aegis.type.xml.DocumentType;
import org.grails.xfire.aegis.type.xml.JDOMDocumentType;
import org.grails.xfire.aegis.type.xml.JDOMElementType;
import org.grails.xfire.aegis.type.xml.SourceType;
import org.grails.xfire.aegis.type.xml.XMLStreamReaderType;
    ...
    implements TypeMappingRegistry
{
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#getDefaultTypeMapping()
     */
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#getRegisteredEncodingStyleURIs()
     */
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#getTypeMapping(java.lang.String)
     */
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#createTypeMapping(boolean)
     */
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#createTypeMapping(String,
     *      boolean)
     */
    ...
    protected TypeCreator createTypeCreator()
    {
        ...
        if (isJDK5andAbove())
        {
            try
            {
                String j5TC = "org.grails.xfire.aegis.type.java5.Java5TypeCreator";
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#unregisterTypeMapping(java.lang.String)
     */
    ...
    /**
     * @see org.grails.xfire.aegis.type.TypeMappingRegistry#clear()
     */
    public void clear()
    {
        registry.clear();
    ...
    protected void createDefaultMappings(TypeMapping tm)
    {
        ...
        if ( isJDK5andAbove())
        {
            registerIfAvailable(tm, "javax.xml.datatype.Duration", XSD_DURATION, "org.grails.xfire.aegis.type.java5.DurationType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_DATE, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_TIME, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_G_DAY, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_G_MONTH, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_G_MONTH_DAY, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_G_YEAR, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_G_YEAR_MONTH, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
            registerIfAvailable(tm, "javax.xml.datatype.XMLGregorianCalendar", XSD_DATETIME, "org.grails.xfire.aegis.type.java5.XMLGregorianCalendarType");
        }
    }
